...
- **🔬 深度研究面板(5 引擎并排对比)**:DeerFlow / GPT Researcher / Open Deep Research / STORM / 自有方法论 skill,研究框架多选 + 精修项 + 过程推理实时可见 + 带引用报告下载/预览。引擎本机环境用 [`harness/`](harness/) 一键安装(密钥外置,详见其中的踩坑实录)
